...
const AuthLayout = ({children}) => {
  return <div className='flex'>
    <div className='w-sereen h-screen md:w-[60vw] px-12 pt-8 pb-12'>
    ...
    <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat overflow-hidden p-8 relative'>
        ...
        <div className='w-48 h-56 rounded-[40px] border-[20px] border-fuchsia-600 absolute top-[220px] -right-10' />
        ...
        <img
            src={CARD_2}
            className='w-64 lg:w-[90%] absolute bottom-3 shadow-lg shadow-blue-400/15 rounded-[15px]'
        />
    </div>
  </div>
}
